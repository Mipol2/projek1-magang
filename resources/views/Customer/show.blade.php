    ...
    <div class="container d-flex justify-content-center">
        <form action="{{ route('customers.update', $customer) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="integer" name="customer_id" id="customer_id" class="form-control" value="{{ $customer->customer_id }}" disabled>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body d-flex justify-content-center align-items-center">
                <form action="{{ route('customers.update', $customer) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="address" class="form-label">Address:</label>
                        <input type="text" name="address" id="address" class="form-control h-100" value="{{ $customer->address }}" disabled>
                    </div>
        
                    <div class="mb-3">
                        <label for="currentImage" class="form-label">Current Image:</label>
                        <img  class="form-control" src="{{ asset('images/' . $customer->avatar) }}" alt="Avatar" style="width: 100px; height: 100px">
                    </div>
                </form>
              </div>
              <!-- /.card-body -->
