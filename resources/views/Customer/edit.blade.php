                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex justify-content-center align-items-center">
                                        <form id="form-update" action="{{ route('customers.update', $customer) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="integer" name="customer_id" id="customer_id"
                                                    class="form-control" value="{{ $customer->customer_id }}">
                                            </div>

                                            <div class="mb-3">
                                                <label for="address" class="form-label">Address:</label>
                                                <input type="text" name="address" id="address"
                                                    class="form-control h-100" value="{{ $customer->address }}">
                                            </div>

                                            <div class="mb-3">
                                                <label for="currentImage" class="form-label">Current Image:</label>
                                                <img class="form-control"
                                                    src="{{ asset('storage/images/' . $customer->image) }}" alt="image"
                                                    style="width: 100px;">
                                            </div>
                ...
                $('#form-update').submit(function (event) {
                   ...
                   var formData = new FormData(this)
                    ...
                    $.ajax({
                        ...
                        data: formData,
                        contentType: false, // Mengatur contentType menjadi false agar FormData bisa dikirim dengan benar
                        processData: false,
                        dataType: 'json',
